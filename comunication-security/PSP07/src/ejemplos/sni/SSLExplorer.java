...
public final class SSLExplorer {
     ...
     * <P>
     * This method accesses the {@code source} parameter in read-only mode, and
     * does not update the buffer's properties such as capacity, limit,
     * position, and mark values.
     *
     * @param source a {@link ByteBuffer} containing inbound or outbound network
     * data for an SSL/TLS connection.
     ...
     * <P>
     * This method tries to parse as few bytes as possible from {@code source}
     * byte array to get the length of an SSL/TLS record.
     *
     * @param source a byte array containing inbound or outbound network data
     ...
     * occurs. The behavior of this method is not defined in this release if the
     * handshake has begun, or has completed.
     * <P>
     * This method accesses the {@code source} parameter in read-only mode, and
     * does not update the buffer's properties such as capacity, limit,
     * position, and mark values.
     ...
     * @throws BufferUnderflowException if not enough source bytes available to
     ...
     * Please NOTE that this method must be called before any handshaking
     * occurs. The behavior of this method is not defined in this release if the
     * handshake has begun, or has completed. Once handshake has begun, or has
     * completed, the security capabilities can not and should not be launched
     * with this method.
     *
     * @param source a byte array containing inbound or outbound network data
     * for an SSL/TLS connection.
